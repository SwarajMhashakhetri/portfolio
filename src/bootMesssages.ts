const bootMessages = [
  ...
  "Bringing up ethernet interface eth0",
  "Starting SSH server",
  ...
  "Starting package manager update service",
  "Starting automatic security updates",
  "Starting cups printing service",
  "Starting NFS file sharing service",
  "Mounting network filesystems",
  "Starting Samba SMB/CIFS service",
  "Starting Docker container service",
  ...
  "Starting user login manager",
  "Login prompt ready",
  "Starting FTP server",
  "Starting Samba NMB daemon",
  "Starting rsyslog service",
  "Starting LVM2 monitoring",
  "Starting Kernel audit service",
  "Starting plymouth boot screen",
  "Starting plymouth boot screen quit",
  "Starting disk quota service",
  ...
  "Starting Hardware random number generator service",
  "Starting Load/Save RF Kill Switch Status",
  "Starting USB gadget pre-setup",
  "Starting timezone sync service",
  "Starting watchdog daemon",
  "Starting kernel crash dump service",
  "Starting Logical Volume Management",
  "Starting swap file service",
  "Starting Smartcard Authentication service",
  "Starting TTY trigger service",
  "Starting screen blanking service",
  "Starting emergency mode",
  "Starting Network Security daemon",
  "Starting wireless regulatory service",
  "Starting Disk Management service",
  "Starting Volume manager service",
  "Starting ZRAM device initialization",
  "Starting Virtual memory service",
  "Starting Task scheduling service",
  "Starting device initialization",
  "Starting Scheduler tick service",
  "Starting process accounting",
  "Starting system integrity checker",
  "Starting CPU frequency scaling",
  "Starting memory management service",
  "Starting user login session",
  "Starting runtime journal service",
  "Starting System performance monitor",
  "Starting Boot loader service",
  "Starting Firmware update service",
  "Starting Input device management",
  "Starting ACPI event daemon",
  "Starting Console setup",
  "Starting Virtual console service",
  "Starting Security audit daemon",
  "Starting device mapper",
  "Starting journal cleanup service",
  "Login prompt ready",
];

export const betterBootMessages = `Welcome to portfolio!
